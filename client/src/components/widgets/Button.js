...
const Button = ({ Icon, text, link, onClick, tooltip, stopPropogation = true, stretch = false, align = 'left', disabled = false, border = false, background = false, vMargin = false, hMargin = false }) => {
    const style = {
